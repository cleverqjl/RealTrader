...
data_1d["return_settle"] = (
    data_1d["settle_price"] / data_1d["settle_price"].shift(1) - 1
)
...
data_1d.loc[short_condition, "signal_short"] = -1  # -1表示做空
...
data_1d.loc[long_condition1, "signal_long"] = 1  # 1表示做多
data_1d.loc[~(long_condition1 | short_condition), "signal"] = 0

data_1d["signal"] = data_1d[["signal_long", "signal_short"]].sum(
    axis=1, min_count=1, skipna=True
)
temp = data_1d[data_1d["signal"].notnull()][["signal"]]
temp = temp[temp["signal"] != temp["signal"].shift(1)]
data_1d["signal"] = temp["signal"]
...
data_1d = pos_to_contract_num(
    data_1d,
    minpoint=0.005,
    slippageMulti=1,
    capitalmode="atr_day",
    capital_unit=1000000,
    contractMulti=1000000,
    limitValue=None,
)
print(
    data_1d[
        ["candle_begin_time", "pos", "close", "open", "trade_price", "contract_num"]
    ]
)
data_1d = contract_num_to_profit(
    data_1d,
    contractMulti=1000000,
    cost=3,
    cost_type="amount",
